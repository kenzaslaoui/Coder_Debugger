...
Original file is located at
    https://colab.research.google.com/drive/1XtWKgOqZCTEVDfVvVKkcVL7UN-0YwtFo
"""

"""
starcoder2.py: Error-enhanced debugger using StarCoder 2
"""
import torch
from transformers import AutoModelForCausalLM, AutoTokenizer

class StarCoderErrorDebugger:
    def __init__(self):
    ...
    def debug_code(self, task: str, buggy_code: str, error: str, max_new_tokens: int = 512) -> str:
        """Error-enhanced debugging with error message"""
    ...
    def format_debug_prompt(self, task: str, buggy_code: str, error: str) -> str:
        """Format prompt for error-enhanced debugging with StarCoder"""
        return (
            f"# Task: {task}\n\n"
            f"# Buggy code:\n{buggy_code}\n\n"
            f"# Error message:\n{error}\n\n"

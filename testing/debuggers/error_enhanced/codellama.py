...
Original file is located at
    https://colab.research.google.com/drive/1nzc716-xCgXjVXbpyKijjSPYaRth6arM
"""

"""
codellama.py: Error-enhanced debugger using CodeLlama
"""
import torch
from transformers import AutoModelForCausalLM, AutoTokenizer

class CodeLlamaErrorDebugger:
    def __init__(self):
    ...
    def format_debug_prompt(self, task: str, buggy_code: str, error: str) -> str:
        """Format prompt for error-enhanced debugging with CodeLlama"""
        return (
            f"<s>[INST] <<SYS>>\n"
            ...
            f"When I ran the code, I got this error:\n{error}\n\n"
